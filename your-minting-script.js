window.addEventListener("load", () => {
    const contractAddress = '0x5b08F44175FFE8970265e31cf3436D845dF7c7BF';
    const contractABI = 
    [
        {
            "inputs": [
...
if(window.ethereum !== undefined || window.ethereum !== null  ){
    ...
    mintButton.addEventListener('click', async () => {
        try {
            ...
            const tokenURI = 'https://drive.google.com/file/d/1pyF0AczhKW-ADgvBTPAcl5Ypz3RCpkS1/view?usp=drive_link';
